	...
	if ( current_user_can( 'manage_product_settings' ) ) {
		if ( isset( $_GET['reset_product_settings'] ) ) {
			if ( isset( $_GET['reset_product_settings_confirm'] ) && check_admin_referer( 'ic_reset_product_settings_confirm' ) ) {
				...
				echo '<a class="button" href="' . esc_url( $confirm_reset_url ) . '">' . __( 'Yes', 'ecommerce-product-catalog' ) . '</a> <a class="button" href="' . esc_url( remove_query_arg( 'reset_product_settings' ) ) . '">' . __( 'No', 'ecommerce-product-catalog' ) . '</a>';
			}
			...
			if ( isset( $_GET['delete_all_products_confirm'] ) && check_admin_referer( 'ic_delete_all_products_confirm' ) ) {
				...
				echo '<a class="button" href="' . esc_url( $delete_products_confirm_url ) . '">' . __( 'Yes', 'ecommerce-product-catalog' ) . '</a> <a class="button" href="' . esc_url( remove_query_arg( 'delete_all_products' ) ) . '">' . __( 'No', 'ecommerce-product-catalog' ) . '</a>';
			}
			...
			if ( isset( $_GET['delete_all_product_categories_confirm'] ) && check_admin_referer( 'ic_delete_all_product_categories_confirm' ) ) {
				...
				echo '<a class="button" href="' . esc_url( $delete_categories_confirm_url ) . '">' . __( 'Yes', 'ecommerce-product-catalog' ) . '</a> <a class="button" href="' . esc_url( remove_query_arg( 'delete_all_product_categories' ) ) . '">' . __( 'No', 'ecommerce-product-catalog' ) . '</a>';
			}
			...
			if ( isset( $_GET['delete_old_filters_bar_confirm'] ) && check_admin_referer( 'ic_delete_old_filters_bar_confirm' ) ) {
				...
				echo '<a class="button" href="' . esc_url( $delete_old_filters_bar_confirm ) . '">' . __( 'OK', 'ecommerce-product-catalog' ) . '</a> <a class="button" href="' . esc_url( remove_query_arg( 'delete_old_filters_bar' ) ) . '">' . __( 'Cancel', 'ecommerce-product-catalog' ) . '</a>';
			}
		} else {
			?>
            <style>table.widefat {
